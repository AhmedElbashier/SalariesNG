...
export class PartialInvoiceComponent {
  empId!:any;
  empName!:any;
  dept!:any;
  program!:any;
  ...
  ngOnInit()
  {
    ...
    this.year = y;
    this.empId  =  localStorage.getItem("partialInvoicePartialId");
    this.empName  =  localStorage.getItem("partialInvoicePartialName");
    this.dept  =  localStorage.getItem("partialInvoicePartialDept");
    this.program  =  localStorage.getItem("partialInvoicePartialProgram");
    ...
    localStorage.setItem("partialInvoicePrint1","1");
  }
}
