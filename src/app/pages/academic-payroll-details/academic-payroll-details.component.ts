import { BooksAndResearch, Absence, Allowance } from './../../services/settings.service';
...
export class AcademicPayrollDetailsComponent implements OnInit{
  ...
  async ngOnInit(): Promise<void> {
    {
      ...
      this.BooksAndResearch =await this.settingService.getBooksAndResearch(this.Emp.tt);
      this.BooksAndResearchValue = parseFloat(this.BooksAndResearch[0].value);
      this.BooksAndResearchValue = parseFloat(this.BooksAndResearchValue) * parseInt(this.degreeRoller[0].primarySalary);
      this.absence = await this.settingService.getAbsenceByName(this.Emp.name,this.month);
      if(this.Emp.tt=="مساعد تدريس")
      {
        this.BooksAndResearchValue="0";
      }
      this.degreeRoller[0].value= parseInt(this.degreeRoller[0].value) + parseInt(this.performanceIncentive) + parseInt(this.internalExpIncentive)+parseInt(this.BooksAndResearchValue);
      ...
      this.discountsTotal = parseInt(this.payRoll.firstInsurance)+parseInt(this.payRoll.stampBase)+parseInt(this.payRoll.personalTax)+parseInt(this.payRoll.theBaseSubjectTax);
      ...
      this.payRoll.bookAndResearch = this.BooksAndResearchValue;
      this.academicBase = parseInt(this.BooksAndResearchValue) + parseInt (this.payRoll.primarySalary);
  ...
  print()
  {
    ...
    localStorage.setItem("academicInvoicePrimaryFirstInsurance",this.payRoll.firstInsurance);
    localStorage.setItem("academicInvoiceStampBase",this.payRoll.stampBase);
    localStorage.setItem("academicInvoicePrimaryPersonalTax",this.payRoll.personalTax);
    localStorage.setItem("academicInvoiceTheBaseSubjectTax",this.payRoll.theBaseSubjectTax);
    localStorage.setItem("academicInvoiceNetBaseSalary",this.FirstTableTotal);
    localStorage.setItem("academicInvoiceStartingSalary",this.payRoll.startingSalary);
    localStorage.setItem("academicInvoiceLivingExpense",this.payRoll.livingExpense);
    localStorage.setItem("academicInvoiceDeportationExpense",this.payRoll.deportationExpense);
    localStorage.setItem("academicInvoiceHousingExpense",this.payRoll.housingExpense);
    localStorage.setItem("academicInvoiceDiscountsTotal",this.discountsTotal);
    localStorage.setItem("academicInvoiceAbsenceLastValue",this.payRoll.absenceLastValue);
    localStorage.setItem("academicInvoiceFirstTableTotal",this.payRoll.secondTableTotal);
  ...
  print2()
  {
    ...
    localStorage.setItem("academicInvoiceEmpDept",this.Emp.dept);
    localStorage.setItem("academicInvoiceEmpType",this.Emp.type);
    localStorage.setItem("academicInvoiceVariableTax",this.payRoll.variableTax);
    localStorage.setItem("academicInvoiceLastInsurance",this.payRoll.lastInsurance);
    localStorage.setItem("academicInvoiceStampSign",this.payRoll.stampSign);
    localStorage.setItem("academicInvoiceTaxOnVariableAllowanceResult",this.payRoll.taxOnVariableAllowanceResult);
    localStorage.setItem("academicInvoiceTaxAbsenceLastValue",this.taxAbsenceLastValue);
    localStorage.setItem("academicInvoiceDiscountsSecondTotal",this.payRoll.discountsSecondTotal);
    ...
    localStorage.setItem("academicInvoiceAllowanceV1",this.payRoll.allowanceV1);
    localStorage.setItem("academicInvoiceAllowanceV2",this.payRoll.allowanceV2);
    localStorage.setItem("academicInvoiceAllowanceV3",this.payRoll.allowanceV3);
    localStorage.setItem("academicInvoiceAllowanceV4",this.payRoll.allowanceV4);
    localStorage.setItem("academicInvoiceAllowanceV5",this.payRoll.allowanceV5);
    localStorage.setItem("academicInvoiceLastAllTotalRoll",this.payRoll.lastAllTotalRoll);
